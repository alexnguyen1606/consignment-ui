            ...
            $(res).each(function (index, item) {
                ...
                if(item.checkHaveChilds==0){
                    if(item.status ==0){
                        ...
                        row += '<span   id="id_cate_root_tree' + item.id + '"  id_cate_root="' + item.id + '" onclick="showChildCateTree(this)" class="carett">&nbsp;<i title="Khóa" class="fas fa-bookmark text-warning"></i>&nbsp;' + item.nameCompetition + '</span>'
                    }
                  //  row += '&nbsp;<input type="checkbox" value="' + item.id + '"  class="check-box-element" name="checkList"  id="checkbox_' + item.id + '"/>'
                    ...
                    if(item.status ==0){
                        ...
                        row += '<span   id="id_cate_root_tree' + item.id + '"  id_cate_root="' + item.id + '" onclick="showChildCateTree(this)" class="carett">&nbsp;<i title="Khóa" class="far fa-dot-circle text-warning"></i>&nbsp;' + item.nameCompetition + '</span>'
                    }
                  //  row += '&nbsp;<input type="checkbox" value="' + item.id + '"  class="check-box-element" name="checkList"  id="checkbox_' + item.id + '"/>'
                }
                ...
                $(res).each(function (index, items) {
                    ...
                    if(items.level ==1){
                        if(items.status==0){
                            ...
                            row += '<span    id_cate_root=' + items.id + '  id="id_cate_root' + items.id + '"   onclick="showChildCateTree(this)"  class="carett"><i title="Khóa" class="fas fa-home text-warning"></i>&nbsp;' + items.nameCompetition + '</span>'
                        }
                      //  row += '&nbsp;<input type="checkbox" value="' + items.id + '"  class="check-box-element" name="checkList"  id="checkbox_' + items.id + '"/>'
                        ...
                        if(items.status==0){
                            ...
                            row += '<span   id_cate_root=' + items.id + '  id="id_cate_root' + items.id + '"   onclick="OnOffActiveTree(this)" style="cursor: pointer"><i title="Khóa" class="far fa-dot-circle text-warning"></i>&nbsp;</i>&nbsp;' + items.nameCompetition + '</span>'
                        }
                    //    row += '&nbsp;<input type="checkbox" value="' + items.id + '"  class="check-box-element" name="checkList"  id="checkbox_' + items.id + '"/>'
                    }
