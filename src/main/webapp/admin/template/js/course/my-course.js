...
jQuery(function ($) {
    $(document).ready(function () {
        ...
        function getCourse(url) {
            ...
            if (url==""||url==null){
                url='/api/admin/course/my-course';
            }
            $.ajax({
                type: "POST",
                url: url,
            ...
            $('#pagination-test').twbsPagination({
                ...
                onPageClick: function (event, page) {
                    if (currentPages != page) {
                        var url = "/api/admin/course/my-course";
                        url+="?page="+page;
                        getCourse(url);
                    }
                }
        ...
        function loadCourse(data) {
            ...
            $.each(data,function (i,v) {
                ...
                row+='<a href="/admin/course/my-course/'+v.id+'?statistic=active"><b>'+v.name+'</b></a>';
