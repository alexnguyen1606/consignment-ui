                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(response.outline.chapters,function (i,v) {
                            ...
                            rowChapter+='<td>';
                            rowChapter+='<button class="btn btn-icon btn_remove btn-danger" type="button" id="'+v.id+'"title="xóa"><i class="fa fa-trash-o">Xóa chương mục</i></button>';
                             rowChapter+= '</td>';
                            rowChapter+='</tr>';
                        });
