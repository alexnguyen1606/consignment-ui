                            ...
                            <div class="panel-right col-md-12">
                                ...
                                <form id="formEdit">
                                    ...
                                    <div class="col-sm-12 mt-3 form-group">
                                        <label class="ward input-label col-md-6 text-right">Tên hộp lưu trữ:</label>
                                        <input class="form-control col-md-6" type="" required name="name"
                                               id="name">
                                    </div>
                                    <div class="col-sm-12 mt-3 form-group">
                                        <label class="ward input-label col-md-6 text-right">Mã hộp:</label>
                                        <input class="form-control col-md-6 " required name="code" id="code">
                                    </div>
                                    <div class="col-sm-12 mt-3 form-group">
...
<script src="/admin/template/js/lockers/list.js"></script>
