                    ...
                    <div class=" col-md-12  form-group ">
                        ...
                        <div class="col-md-8 font-label ">
                            <button type="button" id="create" class="btn color-theme-bg" data-toggle="modal"
                                    ...
                                    class="fa fa-plus-circle mr-1"></i>Thêm chức danh công việc
                            </button>
                        </div>
                        <div class="col-md-2">
        ...
        <div class="modal-dialog modal-m" style="border-radius: 30px">
            ...
            <div class="modal-content font-label ">
                <div class="modal-header color-theme-bg">
                    ...
                    <h4 class="modal-title">Thêm mói chức danh công việc</h4>
                            ...
                            <div class="panel-right col-md-12">
                                ...
                                <form id="formEdit">
                                    ...
                                    <div class="col-sm-12 mt-3 form-group">
                                        <label class="ward input-label col-md-6 text-right">Tên chức danh:</label>
                                        <input class="form-control col-md-6" type="" required name="name"
                                               id="name">
                                    </div>
                                    <div class="col-sm-12 mt-3 form-group">
                                        <label class="ward input-label col-md-6 text-right">Mã chức danh:</label>
                                        <input class="form-control col-md-6 " required name="jobTitleCode" id="jobTitleCode">
                                    </div>
                                    <div class="col-sm-12 mt-3 form-group">
...
<script src="/admin/template/js/user/job-title.js"></script>
